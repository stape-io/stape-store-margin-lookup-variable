...
Product data can be uploaded to Stape Store via the [REST API](https://api.store.stape.io/store-api/v2/doc), and through the Stape Store interface via [CSV import](https://stape.io/blog/profit-tracking-sgtm-stape-store#2-add-product-margin-data-to-stape-store) or manually.
